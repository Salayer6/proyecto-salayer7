...
const translations = {
    ...
    en: {
        ...
        profile_desc: "<strong>Management Controller &amp; Data Operations</strong> with background in <strong>Automotive Engineering (Duoc UC)</strong> and postgraduate studies in <strong>Management Control (FEN Universidad de Chile)</strong>. Specializing in transforming scattered data into profitable business decisions through <strong>Business Intelligence, Data Engineering, and AI Automation</strong>.<br><br>I deliver a hybrid approach merging operational process discipline with business vision and advanced analytics. Proven track record at <strong>Grupo MSUS</strong> companies:<br><br>• <a href='https://sadhanacore.com/' target='_blank' rel='noopener noreferrer' style='color: var(--accent-cyan); font-weight: 600;'>SadhanaCore <i class='fa-solid fa-arrow-up-right-from-square' style='font-size: 0.75em;'></i></a>: Designing and implementing <strong>Business Intelligence dashboards (Power BI, DAX, Power Query)</strong> for internal use. Designing and implementing low-cost outcome analysis dashboards (<strong>Airtable</strong>) for corporate clients; integrating <strong>Prompt Engineering &amp; GenAI</strong> to win public tenders on <strong>Mercado Público (Chile)</strong>; and deploying low-cost ERP sprint-tracking modules automated with <strong>n8n and Python</strong>.<br>• <a href='https://prismadigital.io/' target='_blank' rel='noopener noreferrer' style='color: var(--accent-cyan); font-weight: 600;'>Prisma Digital <i class='fa-solid fa-arrow-up-right-from-square' style='font-size: 0.75em;'></i></a>: Development and deployment of high-engagement <strong>gamified web applications</strong> and an intelligent platform designed to <strong>assist in searching, filtering, and analyzing public tenders and agile procurement (Mercado Público)</strong> with agentic capabilities; developed using <strong>Claude, Antigravity, and n8n</strong>, based on <strong>HTML5+JavaScript</strong> technology, and free high-availability serverless deployment with <strong>Vercel.app</strong>. On the other hand, executing comprehensive technical audits of <strong>SEO, web architecture, and digital analytics (GA4)</strong> for e-commerce platforms such as <a href='https://pizzeando.cl' target='_blank' rel='noopener noreferrer' style='color: var(--accent-cyan); font-weight: 600;'>Pizzeando.cl <i class='fa-solid fa-arrow-up-right-from-square' style='font-size: 0.75em;'></i></a>.<br><br><strong>Direct Reference:</strong> Felipe Ramírez (+56 9 8526 5640) — <em>CEO at SadhanaCore &amp; Head of Sales at Prisma Digital</em>.",
