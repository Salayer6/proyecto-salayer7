...
const translations = {
    es: {
        // Header
        subtitle: "Controller con habilidades de Prompt Engineering y Data Engineering",
        ...
        profile_desc: "En la transición desde la Ingeniería Automotriz hacia el rol de Controller con habilidades de Prompt Engineering y Data Engineering, propongo un perfil mixto que integra una sólida base técnico-operativa en el área de mantención con visión estratégica para empresas modernas. He realizado prácticas en empresas de Grupo MSUS:<br><br><a href='https://sadhanacore.com/' target='_blank' style='color: var(--accent-cyan);'>https://sadhanacore.com/</a><br>• He construido tableros de visualización de datos para clientes internos y externos.<br>• He integrado Inteligencia Generativa en el desarrollo de propuestas comerciales logrando 1 venta de servicios en Mercado Público (Chile).<br>• He operado herramientas de automatización inteligente y a bajo costo para servicios de bienestar para cliente de bufete de abogados.<br>• He implementado flujos de control y análisis de resultados de eventos masivos como media partner para sector del bienestar.<br><br><a href='https://prismadigital.io/' target='_blank' style='color: var(--accent-cyan);'>https://prismadigital.io/</a><br>• He realizado Auditorías SEO para cliente dedicado al e-commerce de productos parrilleros y pizzeros.<br><br><strong>Contacto de referencia:</strong> Felipe Ramírez: +569 8526 5640 \"CEO de Sadhana Core y Head of Sales en Prisma Digital\"",
