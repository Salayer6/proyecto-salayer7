...
const translations = {
    ...
    en: {
        ...
        profile_desc: "In the transition from Automotive Engineering to Prompt and Mining Data Engineering, I propose a mixed profile that integrates a solid technical-operational base in the maintenance area with a strategic vision for modern companies. I have completed internships at Grupo MSUS companies:<br><br><a href='https://sadhanacore.com/' target='_blank' style='color: var(--accent-cyan);'>https://sadhanacore.com/</a><br>• I have built data visualization dashboards for internal and external clients.<br>• I have integrated Generative Intelligence in the development of commercial proposals, achieving 1 service sale in Mercado Público (Chile).<br>• I have operated intelligent, low-cost automation tools for wellness services for a law firm client.<br>• I have implemented control flows and results analysis for mass events as a media partner for the wellness sector.<br><br><a href='https://prismadigital.io/' target='_blank' style='color: var(--accent-cyan);'>https://prismadigital.io/</a><br>• I have performed SEO Audits for a client dedicated to e-commerce of barbecue and pizza products.",
